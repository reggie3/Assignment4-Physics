...
var AmmoPhysicsHelper = {
  ...
  m[3] = 0.0; m[4+3] = 0.0; m[8+3] = 0.0; m[12+3] = 1.0;
     ...
     * @param physicsWorld
     */
    CreateBouncyBall : function(mesh, physicsWorld){
        console.log(mesh);
        mesh.geometry.computeBoundingSphere();


        var shape = new Ammo.btSphereShape(mesh.geometry.boundingSphere.radius * mesh.scale.x);
...
physicsWorld.addRigidBody(body);
     ...
     * @constructor
     */
    CreateStaticBox : function(mesh, physicsWorld){
